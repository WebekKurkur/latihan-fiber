...
type TokenRepository interface {
	...
	RevokeAllForStudents(ctx context.Context, studentID int) error
}
...
// RevokeAllForStudents dipakai ketika password diganti atau ketika
// terdeteksi penyalahgunaan token.
func (r *tokenPostgresRepository) RevokeAllForStudents(
	...
	if err != nil {
		return fmt.Errorf("mencabut seluruh refresh token students: %w", err)
	}
	return nil
}
