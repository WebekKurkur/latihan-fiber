...
// Cause mengembalikan error asli yang mendasari (untuk log).
...
// Validation membungkus peta kesalahan per-field menjadi AppError.
// Status-nya 422 (Unprocessable Entity) — BUKAN 400 — karena request
// dapat dipahami (JSON valid, Content-Type benar) tetapi isinya
// melanggar aturan domain.
